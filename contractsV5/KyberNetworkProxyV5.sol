...
import "./SimpleNetworkInterfaceV5.sol";


////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @title Kyber Network proxy for main contract
contract KyberNetworkProxyV5 is KyberNetworkProxyInterfaceV5, SimpleNetworkInterfaceV5, WithdrawableV5, Utils2V5 {

    KyberNetworkInterfaceV5 public kyberNetworkContract;
    ...
    function tradeWithHint(
        ...
        returns(uint)
    {
        require(src == ETH_TOKEN_ADDRESS || msg.value == 0, "ETH sent for ERC20 -> X trade");
        ...
        if (src == ETH_TOKEN_ADDRESS) {
            ...
            require(src.transferFrom(msg.sender, address(kyberNetworkContract), srcAmount), "failed user token transfer to KN contract");
        }
        ...
        require(reportedDestAmount == tradeOutcome.userDeltaDestAmount, "reported dest amount != actual dest amount");
        require(tradeOutcome.userDeltaDestAmount <= maxDestAmount, "actual dest amount exceeds max dest amount");
        require(tradeOutcome.actualRate >= minConversionRate, "actual rate < min conv rate");
    ...
    function setKyberNetworkContract(KyberNetworkInterfaceV5 _kyberNetworkContract) public onlyAdmin {

        require(address(_kyberNetworkContract) != address(0), "network contract is null");
        ...
        internal returns(TradeOutcome memory outcome)
    {
        ...
        require(userDestBalanceAfter > destBalanceBefore, "underflow: userDestBalanceAfter <= destBalanceBefore");
        require(srcBalanceBefore > userSrcBalanceAfter, "underflow: srcBalanceBefore <= userSrcBalanceAfter");
